...
db.define_table('theaters',Field('fname',requires=IS_NOT_EMPTY()),Field('city',requires=IS_NOT_EMPTY()),Field('Address',requires=IS_NOT_EMPTY()),Field('Website'),Field('movie','string'),Field('coming_soon','string'),Field('price_range'),Field('show_time'))
db.define_table('movie',Field('fname','string'),Field('crew'),Field('rating',requires=IS_FLOAT_IN_RANGE(0,5)),Field('director','string'),Field('release_date','date'),Field('story','string'),Field('duration'))
